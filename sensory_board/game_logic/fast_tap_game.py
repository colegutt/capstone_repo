        ...
        try:
            ...
            while not self.end_game and self.time_remaining > 0:
                ...
                while not user_input:
                    ...
                    if self.gen_funcs.detect_button_press(self.button_dict[current_led_shape]) and all(self.gen_funcs.detect_button_press(self.button_dict[led_shape]) == False for led_shape in self.led_shapes if led_shape != current_led_shape):
                    ...
                    for led_shape in self.led_shapes:
                        if led_shape != current_led_shape and self.gen_funcs.detect_button_press(self.button_dict[led_shape]):
                            user_input = True
