...
class SettingsScreen(QWidget):
    ...
    def create_sound_control(self):
        ...
        sound_control_layout.addWidget(self.sound_percentage)
        
        button_layout = QHBoxLayout()
        button_layout.addWidget(minus_button)
        button_layout.addWidget(plus_button)
        sound_control_layout.addLayout(button_layout)
    ...
    def create_brightness_control(self):
        ...
        # Layout for brightness control
        brightness_control_layout = QVBoxLayout()
        brightness_control_layout.addWidget(brightness_label)
        brightness_control_layout.addWidget(self.brightness_percentage)
        
        button_layout = QHBoxLayout()
        button_layout.addWidget(minus_button)
        button_layout.addWidget(plus_button)
        brightness_control_layout.addLayout(button_layout)
    ...
    def set_title_and_controls(self, title, sound_control, brightness_control, narration_control, back_button):
